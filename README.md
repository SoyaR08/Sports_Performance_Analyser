...
**Currently majority of this github repo belongs to StatsBomb, we'll only use its data and create a python application.**
**Credits to its original creators [here](https://github.com/statsbomb/open-data)**
